        ...
        it('user should be able to login', function (done) {
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    res.header.location.should.include('/') // Success on login redirect to the rute page
                    done();
                })
        })
        ...
        it('user should be directed back to login page, on loging faliure', function (done) {
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    //res.should.have.status(302)
                    res.header.location.should.include('/users/login') // Success on login redirect to the rute page
                    done();
                })
        })
    })
